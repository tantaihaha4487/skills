...
*{{box-sizing:border-box}} body{{margin:0;background:linear-gradient(145deg,#eef2ff 0,#f8fafc 42%,#fef7ed 100%);color:var(--ink);font:16px/1.55 "Noto Sans","Noto Sans Thai",ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif;min-height:100vh}}
